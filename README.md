...
![Terraform Main](screenshots/terraform-main-tf.png)

### Terraform Files

![Terraform Files](screenshots/terraform-file.png)

### Project Structure

![Terraform Directory](screenshots/terraform-file-list.png)

### AWS Console

![AWS Bucket](screenshots/aws-terraform-index.png)
